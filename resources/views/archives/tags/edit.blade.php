...
@section('content')
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <form action="/archives/update/{{ $editData->id }}" method="post" accept-charset="utf-8">

                <div class="form-group">
                    <label for="title" class="control-label">标题:</label>
                    <input id="" name="title" type="text"
                       value="{{ $editData->title }}"    class="form-control" placeholder="title">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="note" id="" class="form-control" selected="{{ $editData->note }}">
                        @foreach($tags as $tag)
